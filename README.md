...
Claudicle lets you turn Claude Code into a persistent, soulful orchestrator, more reminiscent of a Pokémon than a soulless "agent." Your soul grows over time, with three-tier memory, a modularized cognitive pipeline, and channel adapters for Slack, Discord, Telegram, and SMS. Twelve subdaimones personify your skills, "subagents" and tool calls, inheriting lessons from past work. Your council of daimones (modeled after you, your friends, or imaginary characters) oversee your sessions. It ships with zero skills—pair it with any [skill repo](https://github.com/tdimino/claude-code-minoan) to give your agent capabilities.
...
**Sub-Daimones** — Twelve highly-opinionated crafters—the Kotharot—with skills and cognitive flows of their own. See [`docs/sub-daimones.md`](docs/sub-daimones.md).

**Daimones** — Oversee the subdaimones. Drawn from four sources: a past self, a friend's model, a channeled entity, or a soul your Claudicle has shed. See [`docs/daimones.md`](docs/daimones.md).
